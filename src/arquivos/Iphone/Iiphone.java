package arquivos.Iphone;

import arquivos.celular.*;
import arquivos.internet.*;
import arquivos.musica.*;

public class Iiphone implements AparelhoTelefonico, NavegadorInternet, RepodutorMusical{
